...
namespace EventStore.Core.Util
{
    public static class Opts
    {
        ...
        public const string NonPromotableDescr = "Whether or not this node is is allowed to join into elections if false this node is just an async replica";
        public static readonly bool NonPromotableDefault = false;
